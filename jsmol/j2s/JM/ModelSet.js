...
function (modelIndex) {
return (!this.haveUnitCells || modelIndex < 0 || modelIndex >= this.mc ? null : this.am[modelIndex].simpleCage != null ? this.am[modelIndex].simpleCage : this.unitCells == null || modelIndex >= this.unitCells.length || !this.unitCells[modelIndex].haveUnitCell () ? null : this.unitCells[modelIndex]);
}, "~N");
...
}return  Clazz.newIntArray (-1, [matchHbond ? this.autoHbond (bsA, bsB, false) : this.autoBondBs4 (bsA, bsB, null, bsBonds, this.vwr.getMadBond (), legacyAutoBond), 0]);
...
var bs =  new JU.BS ();
if (this.haveBioModels) this.bioModelset.getConformations (modelIndex, conformationIndex, doSet, bsAtoms, bs);
return bs;
}, "~N,~N,~B,JU.BS");
